...
class WPO_Menu_Cart_Pro {
	...
	public function translations() {
		 ...
		 * 	 	- wp-menu-cart-pro/languages/wp-menu-cart-LOCALE.mo (which if not found falls back to:)
		 * 	 	- WP_LANG_DIR/plugins/wp-menu-cart-LOCALE.mo
		 */
	 ...
	 * @return boolean
	 */
	public function is_shop_active( $active_plugins = array() ) {
	...
	public function need_shop() {
		$error = __( 'WP Menu Cart Pro could not detect an active shop plugin. Make sure you have activated at least one of the supported plugins.' , 'wp-menu-cart' );
	...
	public function free_version_active() {
		$error = __( 'The free version of WP Menu Cart is currently activated, you need to disable or uninstall it for WP Menu Cart Pro to function properly' , 'wp-menu-cart' );
		$message = '<div class="error"><p>' . $error . '</p></div>';
		echo $message;
	}
	...
	public function required_php_version() {
		$error = __( 'WP Menu Cart Pro requires PHP 5.3 or higher (5.6 or higher recommended).', 'wp-menu-cart' );
	...
	****************************************************************************/
	...
	public function deactivate_free_version() {
		...
		$free_versions = array (
			...
			'wp-menu-cart.php/wp-menu-cart.php'						// CURRENT
		);
