...
class WPO_Menu_Cart_Pro_Data {
	...
	public function main_li_class() {
		$classes = 'wpmenucart wpmenucartli wpmenucart-display-'.WPO_Menu_Cart_Pro()->main_settings['items_alignment'];
	...
	public function main_item_content() {
		...
		$cart_contents = sprintf(_n('%d item', '%d items', $item_count, 'wp-menu-cart'), $item_count);
	...
	public function empty_cart_text() {
		$text = __('your cart is currently empty', 'wp-menu-cart');
	...
	public function view_cart_text() {
		$text = __('View your shopping cart', 'wp-menu-cart');
