...
class WPO_Menu_Cart_Pro_Assets {
	...
	public function frontend_scripts_styles ( $hook ) {
		...
		if ( isset( WPO_Menu_Cart_Pro()->main_settings['builtin_ajax'] ) || in_array( WPO_Menu_Cart_Pro()->main_settings['shop_plugin'], array( 'WP e-Commerce', 'eShop', 'Easy Digital Downloads' ) ) ) {
			wp_enqueue_script(
				'wpmenucart',
