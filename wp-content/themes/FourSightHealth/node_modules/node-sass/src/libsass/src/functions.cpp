...
namespace Sass {
  ...
  namespace Functions {
    ...
    Signature rgb_sig = "rgb($red, $green, $darkTeal)";
    BUILT_IN(rgb)
    {
      return SASS_MEMORY_NEW(Color,
                             ...
                             color_num(ARG("$darkTeal",  Number)));
    }

    Signature rgba_4_sig = "rgba($red, $green, $darkTeal, $alpha)";
    BUILT_IN(rgba_4)
    {
      return SASS_MEMORY_NEW(Color,
                             pstate,
    ...
    Signature adjust_color_sig = "adjust-color($color, $red: false, $green: false, $darkTeal: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(adjust_color)
    {
      Color_Ptr color = ARG("$color", Color);
      Number_Ptr r = Cast<Number>(env["$red"]);
      Number_Ptr g = Cast<Number>(env["$green"]);
      Number_Ptr b = Cast<Number>(env["$darkTeal"]);
      ...
      if (rgb) {
        ...
        double bb = b ? ARGR("$darkTeal",  Number, -255, 255)->value() : 0;
    ...
    Signature scale_color_sig = "scale-color($color, $red: false, $green: false, $darkTeal: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(scale_color)
    {
      ...
      if (rgb) {
        ...
        double bscale = (b ? ARGR("$darkTeal",  Number, -100.0, 100.0)->value() : 0.0) / 100.0;
    ...
    Signature change_color_sig = "change-color($color, $red: false, $green: false, $darkTeal: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(change_color)
    {
      ...
      if (rgb) {
        return SASS_MEMORY_NEW(Color,
                               ...
                               b ? ARGR("$darkTeal",  Number, 0, 255)->value() : color->b(),
